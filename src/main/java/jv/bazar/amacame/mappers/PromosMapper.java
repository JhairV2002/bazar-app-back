...
public interface PromosMapper {
    ...
    Promos promoReqDTOToPromos(PromoReqDTO promoReqDto);

    PromoReqDTO promosToPromoReqDTO(Promos promos);

    List<PromoReqDTO> promosListToPromoReqDTOList(List<Promos> promosList);
}
